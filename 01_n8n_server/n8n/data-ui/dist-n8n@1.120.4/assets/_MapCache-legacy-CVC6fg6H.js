    ...
    return {
      ...
      execute: function () {
        ...
        */
        ...
        error$1 = "Error";
        forgotPassword$1 = "Forgot my password";
        settings$1 = "Settings";
        startupError$1 = "Error connecting to n8n";
        en_default = {
        ...
        //#region ../@n8n/i18n/src/locales/zh-CN.json
        _reusableBaseText = {
          "cancel": "取消",
          "codeNodeEditor": {
            "linter": {
              "useJson": "访问 `.json` 下的项目属性，例如 `item.json`"
            },
            "completer": {
              "all": "返回节点输出项的数组",
              "first": "返回节点输出的第一个项目",
        ...
        zh_CN_default = {
          ...
          "chatHub.agent.customAgents": "自定义代理",
          ...
          "mcp.productionCheklist.title": "启用MCP访问",
          "mcp.productionCheklist.description": "允许MCP客户端访问此工作流",
          ...
          "projectRoles.workflow:update.tooltip": "编辑工作流内容，激活/停用，以及执行工作流",
          ...
          "settings.mcp": "MCP 访问",
          "settings.mcp.toggle.label": "启用MCP",
          "settings.mcp.toggle.description": "启用对该 n8n 实例的 MCP 访问权限",
          ...
          "settings.mcp.empty.title": "没有可用的MCP工作流",
          "settings.mcp.empty.description": "在每个工作流的设置中启用MCP访问以在此查看它们。",
          "settings.mcp.toggle.disabled.tooltip": "只有实例管理员可以更改此设置。",
          "settings.mcp.toggle.error": "更新MCP访问时出错",
          "settings.mcp.instructions.enableAccess": "通过其设置在至少一个工作流中启用工作流访问权限",
          "settings.mcp.instructions.serverUrl": "服务器 URL",
          "settings.mcp.instructions.apiKey.label": "访问令牌",
          "settings.mcp.instructions.json": "或者在你的 'mcp.json' 文件中使用以下代码",
          ...
          "settings.mcp.newKey.notice": "请确保现在复制您的访问令牌。您将无法再次查看或复制它！",
          ...
          "dataTable.addColumn.alreadyExistsError": "该列已经存在",
