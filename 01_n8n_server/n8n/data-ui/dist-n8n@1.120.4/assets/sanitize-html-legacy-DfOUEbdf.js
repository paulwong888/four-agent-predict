;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./empty-legacy-DnVUoqbC.js", "./path-browserify-legacy-DJbEMZcd.js"], function (_export, _context) {
    "use strict";

    var __toCommonJS, __esm, __toESM, __export, __commonJS, init_dist, global, require_callBound, require___vite_browser_external, init_dist$1, require_get_intrinsic, init_empty, Buffer, empty_exports, require_path_browserify, require_punycode, require_decode_data_html, require_decode_data_xml, require_decode_codepoint, require_decode, require_Tokenizer, require_Parser, require_lib$6, require_node$1, require_lib$5, require_encode_html, require_escape, require_encode, require_lib$4, require_foreignNames, require_lib$3, require_stringify$2, require_traversal, require_manipulation, require_querying, require_legacy, require_helpers, require_feeds, require_lib$2, require_lib$1, require_escape_string_regexp, require_is_plain_object, require_cjs, require_parse_srcset, require_picocolors_browser, require_css_syntax_error, require_stringifier, require_stringify$1, require_symbols, require_node, require_comment, require_declaration, require_container, require_at_rule, require_document, require_non_secure, source_map_js_shim_exports, source_map_js_shim_default, init_source_map_js_shim, require_object_inspect, require_side_channel, require_formats, require_utils, require_stringify, require_parse$1, require_lib, url_exports, import_punycode, import_lib, punycode, protocolPattern, portPattern, simplePathPattern, unwise, autoEscape, nonHostChars, hostEndingChars, hostnameMaxLen, hostnamePartPattern, hostnamePartStart, unsafeProtocol, hostlessProtocol, slashedProtocol, querystring, parse$4, resolve$1$1, resolveObject, format, Url_1, _globalThis, formatImport, parseImport, resolveImport, UrlImport, URL$1, URLSearchParams, percentRegEx, backslashRegEx, newlineRegEx, carriageReturnRegEx, tabRegEx, CHAR_FORWARD_SLASH, domainToASCII, domainToUnicode, pathToFileURL$2, fileURLToPath$1, formatImportWithOverloads, api, init_url, require_previous_map, require_input, require_root, require_list, require_rule, require_fromJSON, require_map_generator, require_tokenize, require_parser, require_parse, require_warning, require_result, require_warn_once, require_lazy_result, require_no_work_result, require_processor, require_postcss, require_sanitize_html;
    function Url() {
      this.protocol = null;
      this.slashes = null;
      this.auth = null;
    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        require_callBound = _emptyLegacy00tJs.a;
        require___vite_browser_external = _emptyLegacy00tJs.b;
        init_dist$1 = _emptyLegacy00tJs.i;
        require_get_intrinsic = _emptyLegacy00tJs.l;
      ...
      execute: function () {
        //#region ../../../node_modules/.pnpm/punycode@1.4.1/node_modules/punycode/punycode.js
        _export("n", require_punycode = /* @__PURE__ */__commonJS({
            ...
            (function (root) {
              ...
              */
              ...
              if (typeof define == "function" && typeof define.amd == "object" && define.amd) define("punycode", function () {
                ...
                if (module.exports == freeExports) freeModule.exports = punycode$1;else for (key in punycode$1) punycode$1.hasOwnProperty(key) && (freeExports[key] = punycode$1[key]);
        ...
        require_decode_data_html = /* @__PURE__ */__commonJS({
        ...
        require_decode_data_xml = /* @__PURE__ */__commonJS({
        ...
        require_decode_codepoint = /* @__PURE__ */__commonJS({
        ...
        require_decode = /* @__PURE__ */__commonJS({
            ...
            var EntityDecoder = function () {
              ...
              */
              EntityDecoder$1.prototype.stateNumericHex = function (str, offset) {
                ...
                while (offset < str.length) {
                  ...
                  if (isNumber$2(char) || isHexadecimalCharacter(char)) offset += 1;else {
              ...
              */
              EntityDecoder$1.prototype.stateNumericDecimal = function (str, offset) {
                ...
                while (offset < str.length) {
                  var char = str.charCodeAt(offset);
                  if (isNumber$2(char)) offset += 1;else {
              ...
              */
              EntityDecoder$1.prototype.emitNumericEntity = function (lastCp, expectedLength) {
                ...
                if (lastCp === CharCodes$1.SEMI) this.consumed += 1;else if (this.decodeMode === DecodingMode.Strict) return 0;
        ...
        //#region ../../../node_modules/.pnpm/htmlparser2@8.0.2/node_modules/htmlparser2/lib/Tokenizer.js
        require_Tokenizer = /* @__PURE__ */__commonJS({
            ...
            var Tokenizer = function () {
              ...
              */
              ...
              Tokenizer$1.prototype.stateSpecialStartSequence = function (c) {
                ...
                if (!(isEnd ? isEndOfTagSection(c) : (c | 32) === this.currentSequence[this.sequenceIndex])) this.isSpecial = false;else if (!isEnd) {
                  this.sequenceIndex++;
                  return;
                }
                this.sequenceIndex = 0;
              ...
              */
              ...
              Tokenizer$1.prototype.stateBeforeTagName = function (c) {
                if (c === CharCodes.ExclamationMark) {
                  ...
                  var lower = c | 32;
                  this.sectionStart = this.index;
                  if (!this.xmlMode && lower === Sequences.TitleEnd[2]) this.startSpecial(Sequences.TitleEnd, 3);else this.state = !this.xmlMode && lower === Sequences.ScriptEnd[2] ? State.BeforeSpecialS : State.InTagName;
                } else if (c === CharCodes.Slash) this.state = State.BeforeClosingTagName;else {
                  this.state = State.Text;
                  this.stateText(c);
                }
              };
              ...
              Tokenizer$1.prototype.stateBeforeClosingTagName = function (c) {
                if (isWhitespace(c)) {} else if (c === CharCodes.Gt) this.state = State.Text;else {
              ...
              Tokenizer$1.prototype.stateBeforeAttributeName = function (c) {
                if (c === CharCodes.Gt) {
                  ...
                  this.sectionStart = this.index + 1;
                } else if (c === CharCodes.Slash) this.state = State.InSelfClosingTag;else if (!isWhitespace(c)) {
              ...
              Tokenizer$1.prototype.stateAfterAttributeName = function (c) {
                if (c === CharCodes.Eq) this.state = State.BeforeAttributeValue;else if (c === CharCodes.Slash || c === CharCodes.Gt) {
              ...
              Tokenizer$1.prototype.stateBeforeSpecialS = function (c) {
                var lower = c | 32;
                if (lower === Sequences.ScriptEnd[3]) this.startSpecial(Sequences.ScriptEnd, 4);else if (lower === Sequences.StyleEnd[3]) this.startSpecial(Sequences.StyleEnd, 4);else {
                  this.state = State.InTagName;
                  this.stateInTagName(c);
                }
              };
              Tokenizer$1.prototype.stateBeforeEntity = function (c) {
                this.entityExcess = 1;
                this.entityResult = 0;
                if (c === CharCodes.Number) this.state = State.BeforeNumericEntity;else if (c === CharCodes.Amp) {} else {
                  this.trieIndex = 0;
              ...
              Tokenizer$1.prototype.stateInNamedEntity = function (c) {
                ...
                if (masked) {
                  ...
                  if (!this.allowLegacyEntity() && c !== CharCodes.Semi) this.trieIndex += valueLength;else {
              ...
              Tokenizer$1.prototype.stateInNumericEntity = function (c) {
                if (c === CharCodes.Semi) this.emitNumericEntity(true);else if (isNumber$1(c)) {
                  this.entityResult = this.entityResult * 10 + (c - CharCodes.Zero);
                  this.entityExcess++;
                } else {
                  if (this.allowLegacyEntity()) this.emitNumericEntity(false);else this.state = this.baseState;
                  this.index--;
                }
              };
        ...
        //#region ../../../node_modules/.pnpm/htmlparser2@8.0.2/node_modules/htmlparser2/lib/Parser.js
            ...
            var Parser$2 = function () {
              ...
              Parser$3.prototype.emitOpenTag = function (name) {
                ...
                if (!this.isVoidElement(name)) {
                  ...
                  if (foreignContextElements.has(name)) this.foreignContext.push(true);else if (htmlIntegrationElements.has(name)) this.foreignContext.push(false);
                }
        ...
        require_lib$6 = /* @__PURE__ */__commonJS({
          ...
          "../../../node_modules/.pnpm/domhandler@5.0.3/node_modules/domhandler/lib/node.js": exports => {
            ...
            */
            function cloneNode$1(node, recursive) {
              if (recursive === void 0) recursive = false;
              var result;
              if (isText(node)) result = new Text(node.data);else if (isComment(node)) result = new Comment$5(node.data);else if (isTag(node)) {
        ...
        require_lib$5 = /* @__PURE__ */__commonJS({
            ...
            var DomHandler = function () {
              ...
              */
              ...
              DomHandler$1.prototype.handleCallback = function (error) {
                if (typeof this.callback === "function") this.callback(error, this.dom);else if (error) throw error;
              };
        ...
        require_encode_html = /* @__PURE__ */__commonJS({
        ...
        require_escape = /* @__PURE__ */__commonJS({
        ...
        require_encode = /* @__PURE__ */__commonJS({
        ...
        require_lib$4 = /* @__PURE__ */__commonJS({
        ...
        require_foreignNames = /* @__PURE__ */__commonJS({
        ...
        require_lib$3 = /* @__PURE__ */__commonJS({
            ...
            */
            ...
            function renderTag(elem, opts) {
              ...
              if (opts.xmlMode === "foreign") {
                ...
                if (elem.parent && foreignModeIntegrationPoints.has(elem.parent.name)) opts = __assign(__assign({}, opts), {
                  xmlMode: false
                });
              }
        ...
        //#region ../../../node_modules/.pnpm/domutils@3.1.0/node_modules/domutils/lib/stringify.js
        require_stringify$2 = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/domutils@3.1.0/node_modules/domutils/lib/stringify.js": exports => {
        ...
        //#region ../../../node_modules/.pnpm/domutils@3.1.0/node_modules/domutils/lib/traversal.js
        require_traversal = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/domutils@3.1.0/node_modules/domutils/lib/traversal.js": exports => {
            Object.defineProperty(exports, "__esModule", {
              value: true
            });
        ...
        //#region ../../../node_modules/.pnpm/domutils@3.1.0/node_modules/domutils/lib/manipulation.js
        require_manipulation = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/domutils@3.1.0/node_modules/domutils/lib/manipulation.js": exports => {
            Object.defineProperty(exports, "__esModule", {
              value: true
            });
            /**
        ...
        //#region ../../../node_modules/.pnpm/domutils@3.1.0/node_modules/domutils/lib/querying.js
        require_querying = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/domutils@3.1.0/node_modules/domutils/lib/querying.js": exports => {
            Object.defineProperty(exports, "__esModule", {
              value: true
            });
            ...
            */
            function findOne(test, nodes, recurse) {
              ...
              for (var i = 0; i < nodes.length && !elem; i++) {
                var node = nodes[i];
                if (!(0, domhandler_1$4.isTag)(node)) continue;else if (test(node)) elem = node;else if (recurse && node.children.length > 0) elem = findOne(test, node.children, true);
              }
              return elem;
            }
        ...
        //#region ../../../node_modules/.pnpm/domutils@3.1.0/node_modules/domutils/lib/legacy.js
        require_legacy = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/domutils@3.1.0/node_modules/domutils/lib/legacy.js": exports => {
            Object.defineProperty(exports, "__esModule", {
              value: true
            });
        ...
        //#region ../../../node_modules/.pnpm/domutils@3.1.0/node_modules/domutils/lib/helpers.js
        require_helpers = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/domutils@3.1.0/node_modules/domutils/lib/helpers.js": exports => {
            Object.defineProperty(exports, "__esModule", {
              value: true
            });
            ...
            */
            function uniqueSort(nodes) {
              ...
              nodes.sort(function (a, b) {
                ...
                if (relative$1 & DocumentPosition.PRECEDING) return -1;else if (relative$1 & DocumentPosition.FOLLOWING) return 1;
                return 0;
              });
              return nodes;
            }
        ...
        //#region ../../../node_modules/.pnpm/domutils@3.1.0/node_modules/domutils/lib/feeds.js
        require_feeds = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/domutils@3.1.0/node_modules/domutils/lib/feeds.js": exports => {
            Object.defineProperty(exports, "__esModule", {
              value: true
            });
        ...
        //#region ../../../node_modules/.pnpm/domutils@3.1.0/node_modules/domutils/lib/index.js
        require_lib$2 = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/domutils@3.1.0/node_modules/domutils/lib/index.js": exports => {
        ...
        //#region ../../../node_modules/.pnpm/htmlparser2@8.0.2/node_modules/htmlparser2/lib/index.js
        ...
        require_escape_string_regexp = /* @__PURE__ */__commonJS({
        ...
        require_is_plain_object = /* @__PURE__ */__commonJS({
        ...
        require_cjs = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/deepmerge@4.3.1/node_modules/deepmerge/dist/cjs.js": (exports, module) => {
            ...
            function deepmerge$1(target, source, options) {
              ...
              if (!(sourceIsArray === Array.isArray(target))) return cloneUnlessOtherwiseSpecified(source, options);else if (sourceIsArray) return options.arrayMerge(target, source, options);else return mergeObject(target, source, options);
            }
        ...
        require_parse_srcset = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/parse-srcset@1.0.2/node_modules/parse-srcset/src/parse-srcset.js": (exports, module) => {
            ...
            */
            (function (root, factory) {
              if (typeof define === "function" && define.amd) define([], factory);else if (typeof module === "object" && module.exports) module.exports = factory();else root.parseSrcset = factory();
            })(exports, function () {
        ...
        require_picocolors_browser = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/css-syntax-error.js
        require_css_syntax_error = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/stringifier.js
        require_stringifier = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/stringify.js
        require_stringify$1 = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/symbols.js
        require_symbols = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/symbols.js": (exports, module) => {
            module.exports.isClean = Symbol("isClean");
            module.exports.my = Symbol("my");
          }
        }); //#endregion
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/node.js
        require_node = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/node.js": (exports, module) => {
            ...
            function cloneNode(obj, parent) {
              ...
              for (let i in obj) {
                if (!Object.prototype.hasOwnProperty.call(obj, i)) /* c8 ignore next 2 */
                  continue;
            ...
            var Node$4 = class {
              constructor(defaults$2 = {}) {
                ...
                for (let name in defaults$2) if (name === "nodes") {
                  this.nodes = [];
                  for (let node of defaults$2[name]) if (typeof node.clone === "function") this.append(node.clone());else this.append(node);
              ...
              toJSON(_, inputs) {
                ...
                for (let name in this) {
                  if (!Object.prototype.hasOwnProperty.call(this, name)) /* c8 ignore next 2 */
                    continue;
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/comment.js
        require_comment = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/declaration.js
        require_declaration = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/container.js
        require_container = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/container.js": (exports, module) => {
            ...
            var Container$7 = class Container$7 extends Node$1 {
              ...
              getProxyProcessor() {
                return {
                  get(node, prop) {
                    if (prop === "proxyOf") return node;else if (!node[prop]) return node[prop];else if (prop === "each" || typeof prop === "string" && prop.startsWith("walk")) return (...args) => {
                    ...
                    };else if (prop === "root") return () => node.root().toProxy();else if (prop === "nodes") return node.nodes.map(i => i.toProxy());else if (prop === "first" || prop === "last") return node[prop].toProxy();else return node[prop];
                  },
                  set(node, prop, value) {
                    if (node[prop] === value) return true;
                    node[prop] = value;
              ...
              normalize(nodes, sample) {
                if (typeof nodes === "string") nodes = cleanSource(parse$6(nodes).nodes);else if (typeof nodes === "undefined") nodes = [];else if (Array.isArray(nodes)) {
                  nodes = nodes.slice(0);
                ...
                } else if (nodes.selector || nodes.selectors) nodes = [new Rule$4(nodes)];else if (nodes.name) nodes = [new AtRule$4(nodes)];else if (nodes.text) nodes = [new Comment$3(nodes)];else throw new Error("Unknown node type in node creation");
                return nodes.map(i => {
                  /* c8 ignore next */
            ...
            Container$7.rebuild = node => {
              if (node.type === "atrule") Object.setPrototypeOf(node, AtRule$4.prototype);else if (node.type === "rule") Object.setPrototypeOf(node, Rule$4.prototype);else if (node.type === "decl") Object.setPrototypeOf(node, Declaration$3.prototype);else if (node.type === "comment") Object.setPrototypeOf(node, Comment$3.prototype);else if (node.type === "root") Object.setPrototypeOf(node, Root$6.prototype);
              node[my$1] = true;
        ...
        /* c8 ignore stop */
        //#endregion
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/at-rule.js
        require_at_rule = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/document.js
        require_document = /* @__PURE__ */__commonJS({
        ...
        require_non_secure = /* @__PURE__ */__commonJS({
        ...
        //#region src/source-map-js-shim.ts
        source_map_js_shim_exports = /* @__PURE__ */__export({
          default: () => source_map_js_shim_default
        });
        init_source_map_js_shim = __esm({
          "src/source-map-js-shim.ts": () => {
            source_map_js_shim_default = {};
          }
        }); //#endregion
        //#region ../../../node_modules/.pnpm/object-inspect@1.13.1/node_modules/object-inspect/index.js
        require_object_inspect = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/object-inspect@1.13.1/node_modules/object-inspect/index.js": (exports, module) => {
            ...
            module.exports = function inspect_(obj, options, depth, seen) {
              var opts = options || {};
              if (has$4(opts, "quoteStyle") && opts.quoteStyle !== "single" && opts.quoteStyle !== "double") throw new TypeError("option \"quoteStyle\" must be \"single\" or \"double\"");
            ...
            function arrObjKeys(obj, inspect$1) {
              ...
              for (var key in obj) {
                ...
                if (hasShammedSymbols && symMap["$" + key] instanceof Symbol) continue;else if ($test.call(/[^\w$]/, key)) xs.push(inspect$1(key, obj) + ": " + inspect$1(obj[key], obj));else xs.push(key + ": " + inspect$1(obj[key], obj));
              }
        ...
        //#region ../../../node_modules/.pnpm/side-channel@1.0.4/node_modules/side-channel/index.js
        require_side_channel = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/qs@6.11.0/node_modules/qs/lib/formats.js
        require_formats = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/qs@6.11.0/node_modules/qs/lib/utils.js
          ...
          "../../../node_modules/.pnpm/qs@6.11.0/node_modules/qs/lib/utils.js": (exports, module) => {
            ...
            var merge = function merge$1(target, source, options) {
              ...
              if (typeof source !== "object") {
                if (isArray$2(target)) target.push(source);else if (target && typeof target === "object") {
              ...
              if (isArray$2(target) && isArray$2(source)) {
                source.forEach(function (item, i) {
                  if (has$3.call(target, i)) {
                    ...
                    if (targetItem && typeof targetItem === "object" && item && typeof item === "object") target[i] = merge$1(targetItem, item, options);else target.push(item);
                  } else target[i] = item;
                });
                return target;
              }
              return Object.keys(source).reduce(function (acc, key) {
                ...
                if (has$3.call(acc, key)) acc[key] = merge$1(acc[key], value, options);else acc[key] = value;
                return acc;
              }, mergeTarget);
            };
            ...
            var encode = function encode$2(str, defaultEncoder, charset, kind, format$1) {
            ...
            var isRegExp = function isRegExp$2(obj) {
            ...
            var combine = function combine$1(a, b) {
              return [].concat(a, b);
            };
        ...
        //#region ../../../node_modules/.pnpm/qs@6.11.0/node_modules/qs/lib/stringify.js
        require_stringify = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/qs@6.11.0/node_modules/qs/lib/stringify.js": (exports, module) => {
            ...
            var stringify$4 = function stringify$7(object, prefix, generateArrayPrefix, commaRoundTrip, strictNullHandling, skipNulls, encoder, filter$3, sort, allowDots, serializeDate, format$1, formatter, encodeValuesOnly, charset, sideChannel) {
              ...
              if (typeof filter$3 === "function") obj = filter$3(prefix, obj);else if (obj instanceof Date) obj = serializeDate(obj);else if (generateArrayPrefix === "comma" && isArray$1(obj)) obj = utils$1.maybeMap(obj, function (value$1) {
              ...
              var objKeys;
              if (generateArrayPrefix === "comma" && isArray$1(obj)) objKeys = [{
                value: obj.length > 0 ? obj.join(",") || null : void 0
              }];else if (isArray$1(filter$3)) objKeys = filter$3;else {
                var keys = Object.keys(obj);
            ...
            module.exports = function (object, opts) {
              ...
              var arrayFormat;
              if (opts && opts.arrayFormat in arrayPrefixGenerators) arrayFormat = opts.arrayFormat;else if (opts && "indices" in opts) arrayFormat = opts.indices ? "indices" : "repeat";else arrayFormat = "indices";
        ...
        //#region ../../../node_modules/.pnpm/qs@6.11.0/node_modules/qs/lib/parse.js
        require_parse$1 = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/qs@6.11.0/node_modules/qs/lib/parse.js": (exports, module) => {
            ...
            var parseValues = function parseQueryStringValues(str, options) {
              ...
              for (i = 0; i < parts.length; ++i) {
                ...
                if (has$1.call(obj, key)) obj[key] = utils.combine(obj[key], val);else obj[key] = val;
              }
              return obj;
            };
        ...
        //#region ../../../node_modules/.pnpm/qs@6.11.0/node_modules/qs/lib/index.js
        ...
        //#region ../../../node_modules/.pnpm/node-stdlib-browser@1.3.1/node_modules/node-stdlib-browser/esm/proxy/url.js
        url_exports = /* @__PURE__ */__export({
          URL: () => URL$1,
        ...
        init_url = __esm({
          "../../../node_modules/.pnpm/node-stdlib-browser@1.3.1/node_modules/node-stdlib-browser/esm/proxy/url.js": () => {
            ...
            protocolPattern = /^([a-z0-9.+-]+:)/i, portPattern = /:[0-9]*$/, simplePathPattern = /^(\/\/?(?!\/)[^?\s]*)(\?[^\s]*)?$/, unwise = ["{", "}", "|", "\\", "^", "`"].concat(["<", ">", "\"", "`", " ", "\r", "\n", "	"]), autoEscape = ["'"].concat(unwise), nonHostChars = ["%", "/", "?", ";", "#"].concat(autoEscape), hostEndingChars = ["/", "?", "#"], hostnameMaxLen = 255, hostnamePartPattern = /^[+a-z0-9A-Z_-]{0,63}$/, hostnamePartStart = /^([+a-z0-9A-Z_-]{0,63})(.*)$/, unsafeProtocol = {
              javascript: true,
              "javascript:": true
            }, hostlessProtocol = {
              javascript: true,
            ...
            Url.prototype.resolveObject = function (relative$1) {
              ...
              var isSourceAbs = result.pathname && result.pathname.charAt(0) === "/",
                isRelAbs = relative$1.host || relative$1.pathname && relative$1.pathname.charAt(0) === "/",
                mustEndAbs = isRelAbs || isSourceAbs || result.host && relative$1.pathname,
              ...
              if (psychotic) {
                ...
                if (relative$1.protocol) {
                  ...
                  if (relative$1.host) if (relPath[0] === "") relPath[0] = relative$1.host;else relPath.unshift(relative$1.host);
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/previous-map.js
        require_previous_map = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/previous-map.js": (exports, module) => {
            init_dist$1();
            var {
              existsSync,
              readFileSync
            } = (init_empty(), __toCommonJS(empty_exports));
            var {
              dirname: dirname$1,
              join
            ...
            } = (init_source_map_js_shim(), __toCommonJS(source_map_js_shim_exports));
            function fromBase64(str) {
              if (Buffer) return Buffer.from(str, "base64").toString();else /* c8 ignore next 2 */
            ...
            var PreviousMap$2 = class {
              ...
              loadMap(file, prev) {
                ...
                if (prev) {
                  if (typeof prev === "string") return prev;else if (typeof prev === "function") {
                  ...
                  } else if (prev instanceof SourceMapConsumer$2) return SourceMapGenerator$2.fromSourceMap(prev).toString();else if (prev instanceof SourceMapGenerator$2) return prev.toString();else if (this.isMap(prev)) return JSON.stringify(prev);else throw new Error("Unsupported previous source map format: " + prev.toString());
                } else if (this.inline) return this.decodeInline(this.annotation);else if (this.annotation) {
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/input.js
        require_input = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/input.js": (exports, module) => {
            ...
            } = (init_url(), __toCommonJS(url_exports));
            ...
            var Input$4 = class {
              ...
              error(message, line, column, opts = {}) {
                ...
                if (origin) result = new CssSyntaxError$1(message, origin.endLine === void 0 ? origin.line : {
                  ...
                  line: origin.endLine
                }, origin.source, origin.file, opts.plugin);else result = new CssSyntaxError$1(message, endLine === void 0 ? line : {
                  column,
                  line
              ...
              origin(line, column, endLine, endColumn) {
                ...
                let fromUrl;
                if (isAbsolute(from.source)) fromUrl = pathToFileURL$1(from.source);else fromUrl = new URL(from.source, this.map.consumer().sourceRoot || pathToFileURL$1(this.map.mapFile));
                let result = {
                  column: from.column,
                ...
                if (fromUrl.protocol === "file:") if (fileURLToPath) result.file = fileURLToPath(fromUrl);else /* c8 ignore next 2 */
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/root.js
        require_root = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/root.js": (exports, module) => {
            ...
            var Root$5 = class extends Container$4 {
              ...
              normalize(child, sample, type) {
                ...
                if (sample) {
                  if (type === "prepend") {
                    if (this.nodes.length > 1) sample.raws.before = this.nodes[1].raws.before;else delete sample.raws.before;
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/list.js
            ...
            var list$2 = {
              ...
              split(string, separators, last) {
                ...
                for (let letter of string) {
                  if (escape$1) escape$1 = false;else if (letter === "\\") escape$1 = true;else if (inQuote) {
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/rule.js
        require_rule = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/fromJSON.js
        require_fromJSON = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/fromJSON.js": (exports, module) => {
            ...
            function fromJSON$1(json, inputs) {
              ...
              if (defaults$2.type === "root") return new Root$4(defaults$2);else if (defaults$2.type === "decl") return new Declaration$2(defaults$2);else if (defaults$2.type === "rule") return new Rule$2(defaults$2);else if (defaults$2.type === "comment") return new Comment$2(defaults$2);else if (defaults$2.type === "atrule") return new AtRule$2(defaults$2);else throw new Error("Unknown node type: " + json.type);
            }
            module.exports = fromJSON$1;
            fromJSON$1.default = fromJSON$1;
          }
        }); //#endregion
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/map-generator.js
        require_map_generator = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/tokenize.js
        require_tokenize = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/parser.js
        require_parser = /* @__PURE__ */__commonJS({
                ...
                for (let i = 0; i < length; i += 1) {
                  ...
                  if (type === "space" && i === length - 1 && !customProperty) clean = false;else if (type === "comment") {
                    ...
                    if (!SAFE_COMMENT_NEIGHBOR[prev] && !SAFE_COMMENT_NEIGHBOR[next]) {
                      if (value.slice(-1) === ",") clean = false;else value += token[1];
                    } else clean = false;
                  } else value += token[1];
                }
                if (!clean) {
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/parse.js
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/warning.js
        require_warning = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/result.js
        require_result = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/warn-once.js
        require_warn_once = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/lazy-result.js
        require_lazy_result = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/lazy-result.js": (exports, module) => {
            ...
            var LazyResult$2 = class LazyResult$2 {
              constructor(processor, css, opts) {
                ...
                let root;
                if (typeof css === "object" && css !== null && (css.type === "root" || css.type === "document")) root = cleanMarks(css);else if (css instanceof LazyResult$2 || css instanceof Result$2) {
                  ...
                  if (root && !root[my]) /* c8 ignore next 2 */
                ...
                for (let plugin of this.plugins) if (typeof plugin === "object") for (let event in plugin) {
                  ...
                  if (!NOT_VISITORS[event]) {
                    if (typeof plugin[event] === "object") {
                      for (let filter$3 in plugin[event]) if (filter$3 === "*") add(plugin, event, plugin[event][filter$3]);else add(plugin, event + "-" + filter$3.toLowerCase(), plugin[event][filter$3]);
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/no-work-result.js
        require_no_work_result = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/processor.js
        require_processor = /* @__PURE__ */__commonJS({
            ...
            var Processor$1 = class {
              ...
              normalize(plugins) {
                ...
                for (let i of plugins) {
                  ...
                  if (typeof i === "object" && Array.isArray(i.plugins)) normalized = normalized.concat(i.plugins);else if (typeof i === "object" && i.postcssPlugin) normalized.push(i);else if (typeof i === "function") normalized.push(i);else if (typeof i === "object" && (i.parse || i.stringify)) {} else throw new Error(i + " is not a PostCSS plugin");
                }
                return normalized;
              }
              process(css, opts = {}) {
                if (!this.plugins.length && !opts.parser && !opts.stringifier && !opts.syntax) return new NoWorkResult(this, css, opts);else return new LazyResult$1(this, css, opts);
              }
              use(plugin) {
        ...
        //#region ../../../node_modules/.pnpm/postcss@8.4.49/node_modules/postcss/lib/postcss.js
        require_postcss = /* @__PURE__ */__commonJS({
            ...
            postcss.plugin = function plugin(name, initializer) {
              ...
              function creator(...args) {
                if (console && console.warn && !warningPrinted) {
                  ...
                  if ({}.LANG && {}.LANG.startsWith("cn")) /* c8 ignore next 7 */
        ...
        //#region ../../../node_modules/.pnpm/sanitize-html@2.12.1/node_modules/sanitize-html/index.js
        _export("t", require_sanitize_html = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/sanitize-html@2.12.1/node_modules/sanitize-html/index.js": (exports, module) => {
            ...
            function sanitizeHtml(html, options, _recursing) {
              ...
              if (options.allowedAttributes) {
                ...
                each(options.allowedAttributes, function (attributes, tag) {
                  ...
                  attributes.forEach(function (obj) {
                    if (typeof obj === "string" && obj.indexOf("*") >= 0) globRegex.push(escapeStringRegexp(obj).replace(/\\\*/g, ".*"));else allowedAttributesMap[tag].push(obj);
                  });
              ...
              each(options.allowedClasses, function (classes, tag) {
                ...
                if (Array.isArray(classes)) {
                  ...
                  classes.forEach(function (obj) {
                    if (typeof obj === "string" && obj.indexOf("*") >= 0) globRegex.push(escapeStringRegexp(obj).replace(/\\\*/g, ".*"));else if (obj instanceof RegExp) allowedClassesRegexMap[tag].push(obj);else allowedClassesMap[tag].push(obj);
                  });
              ...
              each(options.transformTags, function (transform, tag) {
                let transFun;
                if (typeof transform === "function") transFun = transform;else if (typeof transform === "string") transFun = sanitizeHtml.simpleTransform(transform);
                if (tag === "*") transformTagsAll = transFun;else transformTagsMap[tag] = transFun;
              });
              let depth;
              let stack;
              let skipMap;
              ...
              const parser = new htmlparser.Parser({
                onopentag: function (name, attribs) {
                  ...
                  if (!allowedAttributesMap || has(allowedAttributesMap, name) || allowedAttributesMap["*"]) each(attribs, function (value, a) {
                    ...
                    if (!allowedAttributesMap || has(allowedAttributesMap, name) && allowedAttributesMap[name].indexOf(a) !== -1 || allowedAttributesMap["*"] && allowedAttributesMap["*"].indexOf(a) !== -1 || has(allowedAttributesGlobMap, name) && allowedAttributesGlobMap[name].test(a) || allowedAttributesGlobMap["*"] && allowedAttributesGlobMap["*"].test(a)) passedAllowedAttributesMapCheck = true;else if (allowedAttributesMap && allowedAttributesMap[name]) {
                      for (const o of allowedAttributesMap[name]) if (isPlainObject(o) && o.name && o.name === a) {
                        passedAllowedAttributesMapCheck = true;
                        let newValue = "";
                        if (o.multiple === true) {
                          const splitStrArray = value.split(" ");
                          for (const s of splitStrArray) if (o.values.indexOf(s) !== -1) if (newValue === "") newValue = s;else newValue += " " + s;
                    ...
                    if (passedAllowedAttributesMapCheck) {
                      ...
                      if (name === "iframe" && a === "src") {
                        ...
                        try {
                          const parsed = parseUrl(value);
                          if (parsed.isRelativeUrl) allowed = has(options, "allowIframeRelativeUrls") ? options.allowIframeRelativeUrls : !options.allowedIframeHostnames && !options.allowedIframeDomains;else if (options.allowedIframeHostnames || options.allowedIframeDomains) {
                      ...
                      if (a === "class") {
                        ...
                        if (allowedSpecificClasses && allowedWildcardClasses) value = filterClasses(value, deepmerge(allowedSpecificClasses, allowedWildcardClasses), allowedClassesGlobs);else value = filterClasses(value, allowedSpecificClasses || allowedWildcardClasses, allowedClassesGlobs);
                        if (!value.length) {
                          delete frame.attribs[a];
                          return;
                        }
                      ...
                      if (a === "style") {
                        if (options.parseStyleAttributes) try {
                          value = stringifyStyleAttributes(filterCss(postcssParse(name + " {" + value + "}", {
                            map: false
                      ...
                      result += " " + a;
                      if (value && value.length) result += "=\"" + escapeHtml(value, true) + "\"";else if (options.allowedEmptyAttributes.includes(a)) result += "=\"\"";
                    } else delete frame.attribs[a];
                  });
                  if (options.selfClosing.indexOf(name) !== -1) result += " />";else {
                    result += ">";
                ...
                ontext: function (text) {
                  ...
                  if (options.disallowedTagsMode === "discard" && (tag === "script" || tag === "style")) result += text;else {
                    const escaped = escapeHtml(text, false);
                    if (options.textFilter && !addedText) result += options.textFilter(escaped, tag);else if (!addedText) result += escaped;
                  }
                  if (stack.length) {
                ...
                onclosetag: function (name, isImplied) {
                  if (skipText) {
                    skipTextDepth--;
                    if (!skipTextDepth) skipText = false;else return;
                  }
              ...
              */
              function filterCss(abstractSyntaxTree, allowedStyles) {
                ...
                let selectedRule;
                if (allowedStyles[astRules.selector] && allowedStyles["*"]) selectedRule = deepmerge(allowedStyles[astRules.selector], allowedStyles["*"]);else selectedRule = allowedStyles[astRules.selector] || allowedStyles["*"];
            ...
            sanitizeHtml.simpleTransform = function (newTagName, newAttribs, merge$1) {
              ...
              return function (tagName, attribs) {
                let attrib;
                if (merge$1) for (attrib in newAttribs) attribs[attrib] = newAttribs[attrib];else attribs = newAttribs;
                return {
                  tagName: newTagName,
                  attribs
                };
