...
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js"], function (_export, _context) {
    ...
    var __esm, __export, __commonJS, browser, process, cachedSetTimeout, cachedClearTimeout, queue, draining, currentQueue, queueIndex, browserExports, process$1, init_dist$1, require___vite_browser_external, require_es_object_atoms, require_es_errors, require_eval, require_range, require_ref, require_syntax, require_type, require_uri, require_abs, require_floor, require_max, require_min, require_pow, require_round, require_isNaN, require_sign, require_gOPD, require_gopd, require_es_define_property, require_shams, require_has_symbols, require_Reflect_getPrototypeOf, require_Object_getPrototypeOf, require_implementation, require_function_bind, require_functionCall, require_functionApply, require_reflectApply, require_actualApply, require_call_bind_apply_helpers, require_get, require_get_proto, require_hasown, require_get_intrinsic, require_define_data_property, require_has_property_descriptors, require_set_function_length, require_call_bind, require_callBound, buffer, base64Js, lookup, revLookup, Arr, code, i, len, ieee754, Buffer, Blob, BlobOptions, Buffer$1, File, FileOptions, INSPECT_MAX_BYTES, SlowBuffer, TranscodeEncoding, atob, btoa, constants, isAscii, isUtf8, kMaxLength, kStringMaxLength, resolveObjectURL, transcode, init_dist, empty_exports, empty, init_empty;
      ...
      execute: function () {
        _export("x", init_dist$1 = __esm({
          "../../../node_modules/.pnpm/vite-plugin-node-polyfills@0.24.0_rolldown-vite@7.1.16_@types+node@20.19.21_esbuild@0.2_86160ce2579410c2574f22fd74619205/node_modules/vite-plugin-node-polyfills/shims/process/dist/index.js": () => {
            ...
            _export("S", process$1 = /* @__PURE__ */getDefaultExportFromCjs(browserExports));
          }
        })); //#endregion
        //#region __vite-browser-external
        _export("b", require___vite_browser_external = /* @__PURE__ */__commonJS({
        ...
        require_es_object_atoms = /* @__PURE__ */__commonJS({
        ...
        require_syntax = /* @__PURE__ */__commonJS({
        ...
        _export("y", require_type = /* @__PURE__ */__commonJS({
        ...
        _export("v", require_gopd = /* @__PURE__ */__commonJS({
        ...
        _export("_", require_es_define_property = /* @__PURE__ */__commonJS({
        ...
        _export("g", require_shams = /* @__PURE__ */__commonJS({
        ...
        require_has_symbols = /* @__PURE__ */__commonJS({
        ...
        _export("h", require_function_bind = /* @__PURE__ */__commonJS({
        ...
        _export("m", require_functionApply = /* @__PURE__ */__commonJS({
        ...
        _export("d", require_get_proto = /* @__PURE__ */__commonJS({
        ...
        _export("u", require_hasown = /* @__PURE__ */__commonJS({
        ...
        _export("l", require_get_intrinsic = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/get-intrinsic@1.3.0/node_modules/get-intrinsic/index.js": (exports, module) => {
            ...
            var stringToPath = function stringToPath$1(string) {
              ...
              if (first === "%" && last !== "%") throw new $SyntaxError$1("invalid intrinsic syntax, expected closing `%`");else if (last === "%" && first !== "%") throw new $SyntaxError$1("invalid intrinsic syntax, expected opening `%`");
              var result = [];
        ...
        _export("c", require_define_data_property = /* @__PURE__ */__commonJS({
        ...
        _export("s", require_has_property_descriptors = /* @__PURE__ */__commonJS({
        ...
        _export("o", require_set_function_length = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/call-bind@1.0.7/node_modules/call-bind/index.js
        require_call_bind = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/call-bind@1.0.7/node_modules/call-bind/callBound.js
        _export("a", require_callBound = /* @__PURE__ */__commonJS({
