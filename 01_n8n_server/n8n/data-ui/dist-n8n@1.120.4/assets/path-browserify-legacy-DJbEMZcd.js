;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./empty-legacy-DnVUoqbC.js"], function (_export, _context) {
    "use strict";

    var __commonJS, process$1, init_dist, require_path_browserify;
    return {
      ...
      execute: function () {
        ...
        _export("t", require_path_browserify = /* @__PURE__ */__commonJS({
            ...
            var posix = {
              ...
              join: function join() {
                ...
                for (var i = 0; i < arguments.length; ++i) {
                  var arg = arguments[i];
                  assertPath(arg);
                  if (arg.length > 0) if (joined === void 0) joined = arg;else joined += "/" + arg;
                }
              ...
              relative: function relative(from, to) {
                ...
                for (; i <= length; ++i) {
                  if (i === length) {
                    if (toLen > length) {
                      if (to.charCodeAt(toStart + i) === 47) return to.slice(toStart + i + 1);else if (i === 0) return to.slice(toStart + i);
                    } else if (fromLen > length) {
                      if (from.charCodeAt(fromStart + i) === 47) lastCommonSep = i;else if (i === 0) lastCommonSep = 0;
                    }
                    break;
                  }
                  var fromCode = from.charCodeAt(fromStart + i);
                  if (fromCode !== to.charCodeAt(toStart + i)) break;else if (fromCode === 47) lastCommonSep = i;
                }
                var out = "";
              ...
              parse: function parse(path) {
                ...
                if (startDot === -1 || end === -1 || preDotState === 0 || preDotState === 1 && startDot === end - 1 && startDot === startPart + 1) {
                  if (end !== -1) if (startPart === 0 && isAbsolute) ret.base = ret.name = path.slice(1, end);else ret.base = ret.name = path.slice(startPart, end);
                } else {
