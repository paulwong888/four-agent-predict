;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js"], function (_export, _context) {
    "use strict";

    var computed, nextTick, ref, createVNode, defineComponent, reactive, Fragment, watch, createTextVNode, watchEffect, t, n, o, u, d, s, h, f, p, N, k, j, S, L, P;
    function r(e) {
      var o$1 = n[e];
    ...
    function g(e) {
      var t$1 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "root",
        n$1 = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0,
        r$1 = (arguments.length > 3 ? arguments[3] : void 0) || {},
        o$1 = r$1.key,
        a$1 = r$1.index,
        i$1 = r$1.type,
        c$1 = void 0 === i$1 ? "content" : i$1,
        l$1 = r$1.showComma,
        u$1 = void 0 !== l$1 && l$1,
        d$1 = r$1.length,
        s$1 = void 0 === d$1 ? 1 : d$1,
        h$1 = y(e);
      if ("array" === h$1) {
      ...
      if ("object" === h$1) {
        var p$1 = Object.keys(e),
          v$1 = m(p$1.map(function (r$2, o$2, a$2) {
    ...
    return {
      ...
      execute: function () {
        //#region ../../../node_modules/.pnpm/vue-json-pretty@2.6.0_vue@3.5.13_typescript@5.9.2_/node_modules/vue-json-pretty/esm/vue-json-pretty.js
        t = {
          207: (e, t$1, n$1) => {
            e.exports = n$1(452);
          },
          452: e => {
            var t$1 = function (e$1) {
              var t$2,
                n$1 = Object.prototype,
                r$1 = n$1.hasOwnProperty,
                o$1 = "function" == typeof Symbol ? Symbol : {},
                a$1 = o$1.iterator || "@@iterator",
                i$1 = o$1.asyncIterator || "@@asyncIterator",
                c$1 = o$1.toStringTag || "@@toStringTag";
              ...
              function u$1(e$2, t$3, n$2, r$2) {
                var o$2 = t$3 && t$3.prototype instanceof y$1 ? t$3 : y$1,
                  a$2 = Object.create(o$2.prototype);
                return a$2._invoke = function (e$3, t$4, n$3) {
                  ...
                  return function (o$3, a$3) {
                    ...
                    for (n$3.method = o$3, n$3.arg = a$3;;) {
                      ...
                      if ("next" === n$3.method) n$3.sent = n$3._sent = n$3.arg;else if ("throw" === n$3.method) {
              ...
              function V$1(e$2) {
                this.tryEntries = [{
                  tryLoc: "root"
                }], e$2.forEach(S$1, this), this.reset(!0);
              }
              function L$1(e$2) {
                if (e$2) {
                  var n$2 = e$2[a$1];
              ...
              return g$1.prototype = m$1, l$1(k$1, "constructor", m$1), l$1(m$1, "constructor", g$1), g$1.displayName = l$1(m$1, c$1, "GeneratorFunction"), e$1.isGeneratorFunction = function (e$2) {
                ...
                dispatchException: function (e$2) {
                  ...
                  for (var a$2 = this.tryEntries.length - 1; a$2 >= 0; --a$2) {
                    var i$2 = this.tryEntries[a$2],
                      c$2 = i$2.completion;
                    if ("root" === i$2.tryLoc) return o$2("end");
                    if (i$2.tryLoc <= this.prev) {
                      var l$2 = r$1.call(i$2, "catchLoc"),
                        u$2 = r$1.call(i$2, "finallyLoc");
                      if (l$2 && u$2) {
        ...
        u = (f = {
          ...
          render: function () {
            var e = this.nodeType,
              t$1 = this.onClick,
              n$1 = "objectStart" === e || "arrayStart" === e;
          ...
          setup: function (e, t$1) {
            var n$1 = t$1.emit,
              ...
              g$1 = (0, u.computed)(function () {
                var t$2,
                  n$2 = null === (t$2 = e.node) || void 0 === t$2 ? void 0 : t$2.content;
              ...
              O$1 = function () {
                ...
                return {
                  copy: function () {
                    var t$2,
                      n$2 = (t$2 = k().mark(function t$3(n$3) {
                        return k().wrap(function (t$4) {
                          for (;;) switch (t$4.prev = t$4.next) {
                            case 0:
                              return t$4.prev = 0, t$4.next = 3, navigator.clipboard.writeText(n$3);
                            case 3:
                              ...
                              break;
                            case 7:
                              t$4.prev = 7, t$4.t0 = t$4.catch(0), console.error("[vue-json-pretty] Copy failed: ", t$4.t0);
                            case 10:
                            case "end":
                              return t$4.stop();
                          }
              ...
              V$1 = function () {
                var t$2 = e.node,
                  ...
                  r$2 = t$2.path,
                  o$2 = e.rootPath,
                  a$2 = new Function("data", "return data".concat(r$2.slice(o$2.length)))(e.data);
            ...
            return function () {
              ...
              return (0, u.createVNode)("div", {
                ...
                onMouseover: j$1,
                style: e.style
              }, [e.showLineNumber && (0, u.createVNode)("span", {
                class: "vjs-node-index"
              }, [n$2.id + 1]), e.showSelectController && f$1.value && "objectEnd" !== n$2.type && "arrayEnd" !== n$2.type && (0, u.createVNode)(s, {
                isMultiple: i$1.value,
                checked: e.checked,
                onChange: C$1
              }, null), (0, u.createVNode)("div", {
                class: "vjs-indent"
              }, [Array.from(Array(n$2.level)).map(function (t$3, n$3) {
                return (0, u.createVNode)("div", {
                  key: n$3,
                  class: {
                    "vjs-indent-unit": !0,
                ...
                nodeType: n$2.type,
                onClick: N$1
              }, null)]), n$2.key && (0, u.createVNode)("span", {
                class: "vjs-key"
              }, [(t$2 = e.renderNodeKey, t$2 ? t$2({
                node: e.node,
                defaultKey: a$1.value || ""
              }) : a$1.value), (0, u.createVNode)("span", {
                class: "vjs-colon"
              }, [":".concat(e.showKeyValueSpace ? " " : "")])]), (0, u.createVNode)("span", null, ["content" !== n$2.type && n$2.content ? (0, u.createVNode)(d, {
              ...
              }, null) : m$1()]), n$2.showComma && (0, u.createVNode)("span", null, [","]), e.showLength && e.collapsed && (0, u.createVNode)("span", {
                class: "vjs-comment"
              }, [(0, u.createTextVNode)(" // "), n$2.length, (0, u.createTextVNode)(" items ")])]), e.renderNodeActions && (0, u.createVNode)("span", {
                class: "vjs-tree-node-actions"
              }, [L$1()])]);
            };
          }
        });
        L = (0, u.defineComponent)({
          name: "Tree",
          props: V(V({}, j), {}, {
            collapsedNodeLength: {
              type: Number,
          ...
          setup: function (e, t$1) {
            var n$1 = t$1.emit,
              ...
              d$1 = function (t$2, n$2) {
                return a$1.value.reduce(function (r$2, o$2) {
                  var a$2,
                    i$1 = o$2.level >= t$2 || o$2.length >= n$2,
                    c$1 = null === (a$2 = e.pathCollapsible) || void 0 === a$2 ? void 0 : a$2.call(e, o$2);
              ...
              N$1 = (0, u.computed)(function () {
                for (var e$1 = null, t$2 = [], n$2 = a$1.value.length, r$2 = 0; r$2 < n$2; r$2++) {
                  var o$2 = V(V({}, a$1.value[r$2]), {}, {
                      id: r$2
                    }),
                    i$1 = s$1.hiddenPaths[o$2.path];
                  if (e$1 && e$1.path === o$2.path) {
                    var c$1 = "objectStart" === e$1.type,
                      l$1 = V(V(V({}, o$2), e$1), {}, {
              ...
              j$1 = function t$2() {
                ...
                if (n$2) if (e.virtual) {
                  var r$2,
                    a$2 = (null === (r$2 = o$1.value) || void 0 === r$2 ? void 0 : r$2.scrollTop) || 0;
                  if (e.dynamicHeight) {
                    ...
                    var i$1 = function (e$1) {
                      ...
                      c$1 = function (e$1, t$3) {
                        var n$3 = w$1(f$1, e$1 + t$3);
                        return Math.max(0, Math.min(n$3 + 1, h$1.length));
                      }(a$2, e.height),
                      l$1 = Math.max(0, i$1 - 5),
                      d$2 = Math.min(n$2.length, c$1 + 5);
                    ...
                    var p$2 = e.height / e.itemHeight,
                      g$1 = Math.floor(a$2 / e.itemHeight),
                      b$1 = g$1 < 0 ? 0 : g$1 + p$2 > n$2.length ? n$2.length - p$2 : g$1;
                    b$1 < 0 && (b$1 = 0);
                    var k$2 = b$1 + p$2;
              ...
              A = function (e$1, t$2) {
                if (e$1) s$1.hiddenPaths = V(V({}, s$1.hiddenPaths), {}, l({}, t$2, 1));else {
            ...
            return (0, u.watchEffect)(function () {
              ...
              return [e.dynamicHeight, e.itemHeight, a$1.value.length];
            }, function () {
              ...
              var t$2,
                ...
                c$1,
                l$1,
                d$2 = null !== (t$2 = e.renderNodeKey) && void 0 !== t$2 ? t$2 : r$1.renderNodeKey,
                h$2 = null !== (n$2 = e.renderNodeValue) && void 0 !== n$2 ? n$2 : r$1.renderNodeValue,
                f$2 = null !== (i$1 = null !== (c$1 = e.renderNodeActions) && void 0 !== c$1 ? c$1 : r$1.renderNodeActions) && void 0 !== i$1 && i$1,
                p$2 = null === (l$1 = s$1.visibleData) || void 0 === l$1 ? void 0 : l$1.map(function (t$3, n$3) {
                  ...
                  return (0, u.createVNode)("div", {
                    ...
                    style: e.dynamicHeight ? {} : e.itemHeight && 20 !== e.itemHeight ? {
              ...
              return (0, u.createVNode)("div", {
                ...
                style: e.showLineNumber ? V({
                  paddingLeft: "".concat(12 * Number(a$1.value.length.toString().length), "px")
                }, e.style) : e.style
                ...
                style: {
                  height: "".concat(x$1.value, "px")
                }
              }, [(0, u.createVNode)("div", {
                class: "vjs-tree-list-holder-inner",
                style: {
                  transform: "translateY(".concat(s$1.translateY, "px)")
                }
              }, [p$2])])]) : p$2]);
            };
          }
        });
        _export("t", P = o.A); //#endregion
      }
    };
  });
})();