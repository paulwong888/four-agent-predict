      ...
      execute: function () {
        ...
        _export("tn", init_shared_esm_bundler = __esm({
          "../../../node_modules/.pnpm/@vue+shared@3.5.13/node_modules/@vue/shared/dist/shared.esm-bundler.js": () => {
            ...
            _export("pn", isString = val => typeof val === "string");
            _export("mn", isSymbol = val => typeof val === "symbol");
            _export("cn", isObject = val => val !== null && typeof val === "object");
            _export("un", isPromise = val => {
              return (isObject(val) || isFunction(val)) && isFunction(val.then) && isFunction(val.catch);
            });
            objectToString = Object.prototype.toString;
            toTypeString = value => objectToString.call(value);
            _export("wn", toRawType = value => {
              return toTypeString(value).slice(8, -1);
            });
            isPlainObject = val => toTypeString(val) === "[object Object]";
            isIntegerKey = key => isString(key) && key !== "NaN" && key[0] !== "-" && "" + parseInt(key, 10) === key;
            _export("dn", isReservedProp = /* @__PURE__ */makeMap(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"));
            ...
            _export("Cn", toHandlerKey = cacheStringFunction(str => {
            ...
            _export("fn", isSVGTag = /* @__PURE__ */makeMap(SVG_TAGS));
            _export("sn", isMathMLTag = /* @__PURE__ */makeMap(MATH_TAGS));
            _export("hn", isVoidTag = /* @__PURE__ */makeMap(VOID_TAGS));
            ...
            _export("Sn", toDisplayString = val => {
