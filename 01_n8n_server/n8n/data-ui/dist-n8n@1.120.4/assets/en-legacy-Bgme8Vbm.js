...
(function () {
  System.register([], function (_export, _context) {
    ...
    return {
      setters: [],
      execute: function () {
        //#region ../@n8n/design-system/src/locale/lang/en.ts
        _export("t", en_default = {
          "generic.retry": "Retry",
          ...
          "formInput.validator.uppercaseCharsRequired": config => `Must have at least ${config.minimum} uppercase character${config.minimum > 1 ? "s" : ""}`,
